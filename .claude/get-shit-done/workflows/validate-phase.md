...
```
Agent(
  prompt="Read C:/nodejs-apex-oracle/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/nodejs-apex-oracle/.claude/get-shit-done/templates/VALIDATION.md`
