...
```markdown
Read C:/nodejs-apex-oracle/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/nodejs-apex-oracle/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/nodejs-apex-oracle/.claude/agents/gsd-ui-checker.md for instructions.
