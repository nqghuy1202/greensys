...
```bash
INIT=$(node "C:/nodejs-apex-oracle/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/nodejs-apex-oracle/.claude/get-shit-done/templates/spec.md.
