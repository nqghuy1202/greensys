...
Reference full template: `C:/nodejs-apex-oracle/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/nodejs-apex-oracle/.claude/get-shit-done/templates/state.md`.
