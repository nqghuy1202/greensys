...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/nodejs-apex-oracle/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/nodejs-apex-oracle/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/nodejs-apex-oracle/.claude/commands/gsd
AGENTS_DIR=C:/nodejs-apex-oracle/.claude/agents
```
...
<execution_context>
Surface state file: `C:/nodejs-apex-oracle/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/nodejs-apex-oracle/.claude/skills/.gsd-profile`
Engine module: `C:/nodejs-apex-oracle/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/nodejs-apex-oracle/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
