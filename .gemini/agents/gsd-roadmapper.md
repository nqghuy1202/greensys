...
Reference full template: `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/state.md`.
