...
Use template from `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/UI-SPEC.md`
