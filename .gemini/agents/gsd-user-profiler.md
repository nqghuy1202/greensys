...
<reference>
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/nodejs-apex-oracle/.gemini/get-shit-done/references/user-profiling.md` to load:
