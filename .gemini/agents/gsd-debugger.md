...
<required_reading>
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/nodejs-apex-oracle/.gemini
                  → checks C:/nodejs-apex-oracle/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/nodejs-apex-oracle/.gemini/get-shit-done
                  → writes to C:/nodejs-apex-oracle/.gemini/get-shit-done/hooks/
...
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/nodejs-apex-oracle/.gemini/get-shit-done/references/common-bug-patterns.md
