...
<required_reading>
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/ai-frameworks.md
@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-eval-planner.md for instructions.
