...
```
Agent(
  prompt="Read C:/nodejs-apex-oracle/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/SECURITY.md`
