...
<template>
@C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/nodejs-apex-oracle/.gemini/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/nodejs-apex-oracle/.gemini/get-shit-done/workflows/transition.md`.
...
- Follow @C:/nodejs-apex-oracle/.gemini/get-shit-done/workflows/diagnose-issues.md
