...
```bash
INIT=$(node "C:/nodejs-apex-oracle/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/nodejs-apex-oracle/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
