...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/nodejs-apex-oracle/.gemini/agents/gsd-ui-checker.md for instructions.
