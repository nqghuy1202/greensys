...
INSTALL_JS_GLOBAL="C:/nodejs-apex-oracle/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/nodejs-apex-oracle/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
