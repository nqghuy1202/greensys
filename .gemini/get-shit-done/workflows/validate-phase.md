...
```
Agent(
  prompt="Read C:/nodejs-apex-oracle/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/nodejs-apex-oracle/.gemini/get-shit-done/templates/VALIDATION.md`
