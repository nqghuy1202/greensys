        ...
        <div className="erp-main">
          <div className="erp-page-header">
            ...
            <div className="erp-actions">
              <button type="button"className="erp-btn danger"><Icons.Trash size={14} /></button>
              <button type="button"className="erp-btn ghost" style={{ background: '#E8F5EE', color: '#1F7444', border: '1px solid #D4ECDF' }}><Icons.Check size={14} /> Hoàn thành</button>
              <button type="button"className="erp-btn ghost"><Icons.Hash size={14} /></button>
              <button type="button"className="erp-btn ghost"><Icons.Print size={14} /></button>
              <button type="button"className="erp-btn ghost" style={{ background: '#E8F5EE', color: '#1F7444', border: '1px solid #D4ECDF' }}><Icons.Save size={14} /> Lưu</button>
              <button type="button"className="erp-btn ghost"><Icons.Plus size={14} /> Thêm mới</button>
            </div>
          </div>
