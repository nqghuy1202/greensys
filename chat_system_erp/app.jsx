          ...
          <div className={`modal`} onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-header">
              ...
              <div className="modal-header-actions">
                <button type="button"className="icon-btn" title="Lọc"><Icons.Filter size={16} /></button>
                <button type="button"className="icon-btn" title="Cài đặt"><Icons.Cog size={16} /></button>
                <button type="button"className="icon-btn danger" title="Đóng" onClick={() => setModalOpen(false)}><Icons.Close size={18} /></button>
              </div>
            </div>
