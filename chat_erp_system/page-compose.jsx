    ...
    <div className="emp-modal-overlay" onClick={onCancel}>
      <div className="emp-modal" onClick={e => e.stopPropagation()}>
        <div className="emp-modal-head">
          ...
          <button className="icon-btn" onClick={onCancel}><Icons.Close size={16} /></button>
        </div>
        ...
        <div className="emp-modal-foot">
          ...
          <div className="actions">
            ...
            <button className="btn-primary" onClick={() => picked && onSelect(picked)} disabled={!picked} style={!picked ? { opacity: 0.5, cursor: 'not-allowed' } : {}}>
