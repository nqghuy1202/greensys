  ...
  return (
    <div className="main-head">
        ...
        <div className="main-head-sub">
          {chat.type !== 'dm' && (
            <React.Fragment>
              ...
              <span>{chat.members.length} thành viên</span>
      ...
      <div className="main-head-actions">
        <button className="icon-btn" title="Gọi thoại"><Icons.Phone size={16} /></button>
        <button className="icon-btn" title="Gọi video"><Icons.Video size={16} /></button>
        ...
        {chat.type !== 'dm' && <button className="icon-btn" title="Thêm thành viên"><Icons.Users size={16} /></button>}
        <button className={`icon-btn ${infoOpen ? 'active' : ''}`} title="Thông tin" onClick={onToggleInfo}><Icons.PanelR size={16} /></button>
  ...
  return (
    <div className="info-pane-page">
      ...
      <div className="profile-actions">
        <button className="profile-action"><Icons.Bell size={14} /> Bật/tắt thông báo</button>
        <button className="profile-action"><Icons.Pin size={14} /> Ghim nhóm</button>
      </div>
...
const InfoPanelDm = ({ chat }) => {
  ...
  return (
    <div className="info-pane-page">
      ...
      <div className="profile-actions">
        <button className="profile-action"><Icons.Phone size={14} /> Gọi</button>
        <button className="profile-action"><Icons.Video size={14} /> Video</button>
        <button className="profile-action"><Icons.Bell size={14} /> Tắt báo</button>
      </div>
...
const PageMain = ({ chat, onToggleInfo, infoOpen }) => {
  return (
                ...
                return (
                  <div className="contact-card" key={uid}>
                    ...
                    <div className="contact-card-actions">
                      <button className="icon-btn" title="Nhắn tin"><Icons.Send size={14} /></button>
                      <button className="icon-btn" title="Gọi"><Icons.Phone size={14} /></button>
                    </div>
                  </div>
                );
              })}
        ...
        {SAVED_MESSAGES.map(m => (
          <div className="saved-card" key={m.id}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <button className="icon-btn" title="Mở hội thoại"><Icons.ExtLink size={14} /></button>
              <button className="icon-btn" title="Bỏ lưu"><Icons.Bookmark size={14} /></button>
            </div>
          </div>
        ))}
      </div>
