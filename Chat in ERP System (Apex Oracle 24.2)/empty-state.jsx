      ...
      <div className="empty" style={{ flex: 1 }}>
        <div className="empty-card">
          ...
          <div className="empty-actions">
            <button className="btn-primary" onClick={onCreate}><Icons.Plus size={14} /> Tạo nhóm trao đổi</button>
            <button className="btn-ghost"><Icons.User size={14} /> Trao đổi 1-1</button>
          </div>
    ...
    <div className="nested-overlay" onClick={onCancel}>
      <div className="nested-modal" onClick={e => e.stopPropagation()}>
        <div className="nested-head">
          ...
          <button className="icon-btn" style={{ marginLeft: 'auto' }} onClick={onCancel}><Icons.Close size={14} /></button>
        </div>
        ...
        <div className="nested-foot">
          ...
          <button className="btn-primary" onClick={() => onCreate({ name, members: ['me', ...selected] })} disabled={!name.trim() || selected.length === 0}>
