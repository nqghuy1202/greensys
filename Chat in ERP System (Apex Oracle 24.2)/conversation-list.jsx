    ...
    <div className="convo-pane">
      <div className="convo-toolbar">
        ...
        <div className="convo-tabs">
          <button className={`convo-tab ${activeTab === 'all' ? 'active' : ''}`} onClick={() => setActiveTab('all')}>
            Tất cả {totalUnread > 0 && <span className="count">{totalUnread}</span>}
          </button>
          <button className={`convo-tab ${activeTab === 'unread' ? 'active' : ''}`} onClick={() => setActiveTab('unread')}>Chưa đọc</button>
          <button className={`convo-tab ${activeTab === 'mention' ? 'active' : ''}`} onClick={() => setActiveTab('mention')}>@Tôi</button>
        </div>
      </div>
      ...
      <button className="convo-new-btn" onClick={onCreateNew}>
